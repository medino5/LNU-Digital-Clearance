    ...
    <div class="content stack">
        ...
        <div class="grid-2">
            <div class="card">
                ...
                <h2>Add future-proof program metadata</h2>
            ...
            <div class="card">
                ...
                <h2>Manage the active clearance period</h2>
        ...
        <div class="grid-2">
            <div class="card">
                <div class="eyebrow">Create Student Account</div>
                <h2>Provision mobile login credentials</h2>
            ...
            <div class="card">
                ...
                <h2>Set up route targets for approvals</h2>
        ...
        <div class="grid-2">
            ...
            <div class="card">
                ...
                <h2>Active and archived clearance windows</h2>
                <div class="list">
        ...
        <div class="grid-2">
            ...
            <div class="card">
                <div class="eyebrow">Office Accounts</div>
                <h2>Routing targets and position logins</h2>
                <div class="list">
        ...
        <div class="card">
            <div class="toolbar" style="justify-content: space-between; margin-bottom: 18px;">
                <div>
                    <div class="eyebrow">Clearance History</div>
                    <h2 style="margin: 0;">Completed clearance records by semester</h2>
                </div>
            ...
            @forelse($history as $semesterLabel => $records)
                <div class="record" style="margin-bottom: 14px;">
