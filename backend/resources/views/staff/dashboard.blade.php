                            ...
                            <td class="px-4 py-3 text-center align-top">
                                <div class="flex flex-col items-center gap-2">
                                    <div class="inline-flex gap-2">
                                        <button
                                            type="button"
                                            onclick="openViewModal({{ $signature->id }})"
                                            class="px-3 py-1 text-xs font-semibold rounded bg-blue-600 text-white hover:bg-blue-700"
                                        >
                                            View
                                        </button>
                        ...
                        >
                            <div class="w-full max-w-lg rounded-xl bg-white shadow-xl">
                                <div class="flex items-center justify-between border-b px-6 py-4">
                                    ...
                                    <button
                                        type="button"
                                        onclick="closeViewModal({{ $signature->id }})"
                                ...
                                <div class="px-6 py-4 space-y-4">
                                    ...
                                    <div class="border-t pt-4">
                                        ...
                                        <div class="space-y-2">
                                            @forelse($allSignatures as $progressSignature)
                                                @php
                                                    $status = $progressSignature->status;
                                                ...
                                                <div class="flex items-center justify-between rounded-lg border border-gray-200 px-3 py-2">
                                                    <span class="text-sm text-gray-800">
                                                        {{ $progressSignature->designation?->name ?? 'Unknown Office' }}
                                                    </span>
...
<script>
    ...
    function openViewModal(signatureId) {
        const modal = document.getElementById('view-modal-' + signatureId);
        modal.classList.remove('hidden');
        document.body.classList.add('overflow-hidden');
    }

    function closeViewModal(signatureId) {
        const modal = document.getElementById('view-modal-' + signatureId);
