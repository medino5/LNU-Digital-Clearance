...
APP_DEBUG=false
APP_URL=https://lnu-digital-clearance.onrender.com
...
1. Open `https://lnu-digital-clearance.onrender.com/login`.
...
```text
MOBILE_API_BASE_URL=https://lnu-digital-clearance.onrender.com/api
```
